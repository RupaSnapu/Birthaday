    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-pink-200 via-fuchsia-300 to-violet-300 py-24 px-6 sm:px-10 lg:px-20">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <header className="text-center mb-20">
          <h1 className="text-fuchsia-900 text-xl xl:text-3xl  2xl:text-5xl font-extrabold drop-shadow-lg">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16 place-items-center">
          ...
          <div className="group flex flex-col items-center text-center">
            <div className="relative w-48 h-48 bg-pink-400 rounded-full flex flex-col items-center justify-center shadow-2xl border-4 border-white/30 transition-transform duration-500 hover:scale-110 hover:rotate-[360deg]">
          ...
          {/* Paint Brush bubble */}
          <div className="group flex flex-col items-center text-center">
            <div className="relative w-48 h-48 bg-yellow-300 rounded-full flex flex-col items-center justify-center shadow-2xl border-4 border-white/30 transition-transform duration-500 hover:scale-110 hover:rotate-[360deg]">
          ...
          {/* Cake bubble */}
          <div className="group flex flex-col items-center text-center">
            <div className="relative w-48 h-48 bg-purple-400 rounded-full flex flex-col items-center justify-center shadow-2xl border-4 border-white/30 transition-transform duration-500 hover:scale-110 hover:rotate-[360deg]">
              <FaBirthdayCake className="text-white text-6xl mb-2 z-10" aria-label="Birthday Cake Icon" />
              <svg
                viewBox="0 0 24 24"
          ...
          {/* Lightbulb bubble */}
          <div className="group flex flex-col items-center text-center">
            <div className="relative w-48 h-48 bg-orange-300 rounded-full flex flex-col items-center justify-center shadow-2xl border-4 border-white/30 transition-transform duration-500 hover:scale-110 hover:rotate-[360deg]">
        ...
        <div className="mt-24 bg-white/30 backdrop-blur-xl border border-white/40 rounded-full p-10 max-w-2xl mx-auto text-center shadow-2xl">
          ...
          <p className="text-lg md:text-xl 2xl:text-2xl  text-fuchsia-800 xl:text-sm mb-6">
            Book us today and turn every moment into colorful memories you’ll cherish forever.
          </p>
          <Link href="#Contact">
          <button className="inline-flex items-center 2xl:text-2xl  justify-center px-10 py-5 bg-pink-500 text-white text-xl font-bold rounded-full shadow-lg hover:bg-pink-600 transition">
            Book Your Party Now 🎉
          </button>
          </Link>
        </div>
...
//           </h1>
//           <p className="mt-6 text-xl md:text-2xl text-fuchsia-800 max-w-3xl mx-auto">
